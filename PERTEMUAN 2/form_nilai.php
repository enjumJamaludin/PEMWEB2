...
<form action="nilai_siswa.php" method="post" <?php echo $_SERVER['PHP_SELF']; ?>> 
  ...
  <div class="form-group row">
    <label for="Pemweb" class="col-4 col-form-label">Mata Kuliah</label> 
    <div class="col-8">
      <select id="matkul" name="matkul" class="custom-select">


    <?php
    foreach ($sar_matkul as $kode => $nama_matkul) {
        echo "<option value='$kode'>$nama_matkul</option>";
    }
    ?>
  ...
  <div class="form-group row">
    <label for="text2" class="col-4 col-form-label">Tugas Praktikum</label> 
    <div class="col-8">
